...
public class HardwareSimulator {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("Select from the list to simulate");
            System.out.println("basicgates4bit - 1");
            System.out.println("basicgates16 - 2");
            System.out.println("muxes - 3");
            System.out.println("adders - 4");
            System.out.println("alu - 5");
            System.out.println("clock - 6");
            ...
            switch (UserChoice) {
                ...
                case "clock":
                    ...
                    String programChoice = clkusr.nextLine().toUpperCase(); // wheather uppercase or lowercase , this
                                                                            // line changes into Uppercase
                    switch (programChoice) { // switches based on user input
                        ...
                        case "CLOCK":
                            ...
                            break;
                        case default:
                            System.out.println("Just type clock or stop"); // default case if input is not defined in
                                                                           // prior cases
                    }
                    break;
                // !for ALU
